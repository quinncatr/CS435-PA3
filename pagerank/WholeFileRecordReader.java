...
public class WholeFileRecordReader extends RecordReader<NullWritable, BytesWritable> {
	...
	public boolean nextKeyValue() throws IOException, InterruptedException {
		if (!processed) {
			...
			processed = true;
			return true; // #TODO#: Return appropriate boolean value when processing is done
		}
		return false; // #TODO#: Return appropriate boolean value when no more data to process
	}
